...
const addTask = async () => {
  ...
  return (
    <div className="flex flex-col items-center m-12 mb-80">
      ...
      <h1 className="text-2xl font-extrabold mb-6 text-white">Create your new Task</h1>
      ...
      <div className='flex flex-col items-center mt-6'>
        <h1 className="text-2xl font-extrabold mb-6 text-white">Find the Task you're looking for</h1>
        <input 
      ...
      <div className="flex flex-col lg:flex-col items-center lg:justify-center space-x-4 mb-6 mt-6">
        <h1 className="text-2xl font-extrabold mb-6 text-white">Filter your Tasks here</h1>
