      ...
      <div className="flex flex-col items-center justify-center m-12 mb-80">
        ...
        <div className="flex flex-wrap gap-8 justify-center">
          {filteredTasks.map((task) => (
            <div
              key={task.id}
              className={`bg-gray-200/20 h-80 w-80 border rounded-md p-4 rotate-3 transform duration-300 hover:rotate-0 ${
            ...
            >
              ...
              <h3 className="mb-2 text-center text-3xl font-bold mt-4 text-white">
                {task.title}
              </h3>
              <div className='flex justify-center w-22 h-20' style={{wordWrap: "break-word"}}>
