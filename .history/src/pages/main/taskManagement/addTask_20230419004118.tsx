  ...
  return (
    ...
    >
      {({ setFieldValue, values }) => (
        <Form className="flex flex-col sm:flex-row md:flex-row lg:flex- lg:justify-center space-y-4 sm:space-y-0 md:space-y-0 lg:space-y-0 lg:space-x-4 w-full mb-6">
          <Field
            name="title"
            type="text"
            placeholder="Title"
