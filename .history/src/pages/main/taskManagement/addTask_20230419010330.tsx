...
const AddTaskSchema = Yup.object().shape({
  ...
  date: Yup.date()
    .min(new Date(), 'Present or future time!')
    ...
    >
      {({ setFieldValue, values }) => (
        <Form className="flex sm:flex-col md:flex-row lg:flex-row lg:justify-center space-y-4 sm:space-y-0 md:space-y-0 lg:space-y-0 lg:space-x-4 w-full mb-6">
          <div className="flex flex-col justify-center items-center w-full sm:w-56 md:w-64 lg:w-56">
            <Field
              name="title"
              type="text"
              placeholder="Title"
            ...
            />
            <ErrorMessage name="title" component="div" className="text-red-500 font-bold mt-2" />
          </div>
  
          <div className="flex flex-col justify-center items-center w-full sm:w-56 md:w-96 lg:w-96">
            <Field
              name="description"
              type="text"
              ...
              className="border rounded-md px-4 py-2 w-full bg-gray-200/20 text-white"
            />
            <ErrorMessage name="description" component="div" className="text-red-500 font-bold mt-2" />
          </div>
  
          <div className="flex flex-col justify-center items-center w-full sm:w-48 md:w-48 lg:w-48">
            <input
              name="date"
              type="datetime-local"
              ...
              className="border rounded-md px-4 py-2 w-full bg-gray-200/20 text-white"
            />
            <ErrorMessage name="date" component="div" className="text-red-500 font-bold mt-2" />
          </div>
