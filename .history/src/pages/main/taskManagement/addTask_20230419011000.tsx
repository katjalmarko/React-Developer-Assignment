    ...
    >
      {({ setFieldValue, values }) => (
        <Form className="flex sm:flex-col md:flex-row lg:flex-row lg:justify-center space-y-4 sm:space-y-0 md:space-y-0 lg:space-y-0 lg:space-x-4 w-full mb-6">
          ...
          <div className="flex flex-col w-full sm:w-56 md:w-96 lg:w-96">
            <Field
              name="description"
              type="text"
              ...
              className="border rounded-md px-4 py-2 w-full bg-gray-200/20 text-white"
            />
            <ErrorMessage name="description" component="div" className="flex items-center text-red-500 font-bold" />
          </div>
  
          <div className="flex flex-col w-full sm:w-48 md:w-48 lg:w-48">
            <input
              name="date"
              type="datetime-local"
