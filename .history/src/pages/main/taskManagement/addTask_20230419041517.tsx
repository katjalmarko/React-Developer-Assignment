        ...
        <Form className="flex flex-col justify-center sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 md:space-x-6 lg:space-x-8 w-full mb-6">
          <div className="flex flex-col w-full sm:w-56 md:w-64 lg:w-56">
            <Field
              ...
              type="text"
              placeholder="Title"
              className="border rounded-md px-4 py-2 w-full bg-gray-200/20 text-white font-bold text-2xl"
            />
          ...
          <div className="flex flex-col lg:w-48 sm:w-auto">
            <button
              type="submit"
              className="bg-gray-400/40 hover:bg-gray-500/80 text-white font-bold py-2 px-4 rounded sm:w-32 h-11 mt-4 sm:mt-0"
