...
const addTask = async () => {
  ...
  return (
    <div className="flex flex-col items-center m-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 w-full transition-all">
        {filteredToDoList.map((todo) => (
          <div key={todo.id} className={`bg-gray-200/20 border rounded-md p-4 transition-all ${todo.completion ? 'bg-green-400/50' : ''}`}>
