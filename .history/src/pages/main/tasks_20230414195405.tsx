    ...
    <div className="flex flex-col items-center m-12">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-center space-y-4 lg:space-y-0 lg:space-x-4 w-full mb-6">
        ...
        <input
          ...
          className="border rounded-md px-4 py-2 w-full lg:w-48 cursor-pointer"
        />
        <button
          onClick={addTask}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 w-full transition-all duration-1500">
      {filteredToDoList.map((todo) => (
    <div key={todo.id} className={`bg-gray-200/20 border rounded-md p-4 ${todo.completion ? 'bg-green-400/50' : ''} transition-all duration-1500`}>
