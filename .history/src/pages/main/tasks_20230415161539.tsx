...
const addTask = async () => {
  ...
  return (
    ...
    <div key={todo.id} className={`bg-gray-200/20 h-60 w-80 border rounded-md p-4 rotate-3 transform duration-300 hover:rotate-0 ${todo.completion ? 'bg-green-400/50' : ''}`}>
            <div
              className="e top-1/2 left-1/2 habsolut-96 w-80 -translate-x-1/2 -translate-y-1/2 rotate-3 transform rounded-2xl bg-gray-400">
            </div>
            <h6 className="text-center text-xl font-extrabold">
              Finish until:{" "}
            ...
            <h4 className="mb-2 text-center text-5xl font-extrabold text-gray-900">{todo.title}</h4>
