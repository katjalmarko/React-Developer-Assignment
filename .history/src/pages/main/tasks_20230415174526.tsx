  ...
  return (
    <div className="flex flex-col items-center m-12 mb-80">
      ...
      <div className="flex flex-col lg:flex-col items-center lg:justify-center space-x-4 mb-6 mt-6">
        ...
        <button
          className={`bg-green-600 hover:bg-green-800 text-gray-800 font-bold py-2 px-4 rounded ${
        ...
        <button
          className={`bg-orange-300 hover:bg-orange-400 text-gray-800 font-bold py-2 px-4 rounded ${
            ...
            <div className='flex justify-between'>
              ...
              <button
                className={`bg-green-600/80 hover:bg-green-800/80 text-white font-bold py-2 px-4 rounded mt-4 
                              ${todo.completion ? 'bg-orange-300/80 hover:bg-orange-400/80' : ''}`}
                onClick={() => {
                  if (todo.completion) {
