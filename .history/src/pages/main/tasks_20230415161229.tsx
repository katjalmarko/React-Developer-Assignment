...
const addTask = async () => {
  ...
  return (
    ...
    <div key={todo.id} className={`bg-gray-200/20 h-60 w-80 border rounded-md p-4 rotate-3 transform duration-300 hover:rotate-0  hover:bg-gray-600/20 ${todo.completion ? 'bg-green-400/50' : ''}`}>
