        ...
        <div className="flex flex-wrap gap-6 justify-center">
          {filteredTasks.map((task) => (
            ...
            >
              ...
              <h6 className="text-center text-2xl font-black text-white" style={{ textShadow: '0 0 20px black' }}>
                {" "}
              ...
              <h3 className="text-center text-3xl font-bold mt-4 text-gray-900 style={{ textShadow: '0 0 20px black' }}">
                {task.title}
              </h3>
