  ...
  return (
    <div className="flex flex-col items-center m-12 mb-80">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-center space-y-4 lg:space-y-0 lg:space-x-4 w-full mb-6">
        ...
        <button
          onClick={addTask}
          className="bg-gray-200/40 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded w-full lg:w-auto"
        >
          Create Task
        </button>
      </div>
    ...
    <div className=''>
      <div className='flex flex-col lg:justify-center items-center mt-6'>
        <h1 className="text-lg font-bold mb-4 mr-6 text-white">Find the Task you're looking for</h1>
        <input 
      ...
      <div className="flex flex-col items-center lg:flex-row lg:justify-center space-x-4 mb-6 mt-6">
        ...
        <button
          className={`bg-gray-300/60 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded ${
