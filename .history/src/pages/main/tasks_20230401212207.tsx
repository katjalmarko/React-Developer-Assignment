...
const createNewTask = async () => {
  ...
  return (
    <div className="flex flex-col items-center mt-6">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-start space-y-4 lg:space-y-0 mt-4 lg:space-x-4 lg:w-full">
      ...
      <h1 className="text-lg font-bold mt-6">Your To-Do List</h1>
