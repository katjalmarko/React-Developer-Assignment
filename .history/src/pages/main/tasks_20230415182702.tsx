...
const addTask = async () => {
  ...
  return (
    <div className="flex flex-col items-center m-12 mb-80 lg:w-screen-100">
  ...
  <div className="flex flex-col sm:flex-row md:flex-row lg:flex-row lg:justify-center space-y-4 sm:space-y-0 md:space-y-0 lg:space-y-0 lg:space-x-4 w-full mb-6">
    ...
    <button
      onClick={addTask}
      className="bg-gray-400 hover:bg-gray-500 text-white font-bold py-2 px-4 rounded w-full sm:w-auto md:w-auto lg:w-auto"
    >
      Submit
    </button>
  </div>
