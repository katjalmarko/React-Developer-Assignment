  ...
  return (
    <div className="flex flex-col items-center m-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 w-full">
        {toDoList.map((todo) => (
          <div key={todo.id} className={`bg-gray-200/20 border rounded-md p-4 ${todo.completion ? 'bg-green-400/80' : ''}`}>
            ...
            <div className='flex justify-between'>
              ...
              <button
                className={`bg-green-500/80 hover:bg-green-700/80 text-white font-bold py-2 px-4 rounded mt-2 ${todo.completion ? 'bg-orange-500/80 hover:bg-orange-700/80' : ''}`}
                onClick={() => {
                  if (todo.completion) {
