...
const addTask = async () => {
  ...
  {filteredToDoList.map((todo) => (
    <div key={todo.id} className={`relative bg-gray-200/20 border border-gray-400 rounded-md p-4 ${todo.completion ? 'bg-green-400/50' : ''}`}>
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 bg-gray-300/50 rounded-b-md">
