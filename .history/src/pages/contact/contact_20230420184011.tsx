      ...
      <div className="w-full max-w-2xl p-8 bg-gray-700 border border-black rounded-lg shadow-md text-white">
        ...
        <div className="mb-6">
          ...
          <p className="text-center mb-4">
            Something about me: I am a 23-year-old Slovakian who has been continuously educating myself in the field of health since a young age. I haveve also been coaching other people in this area, and that is what I do for a living at the moment.
          </p>
          <p className="text-center mb-4">
