...
import as IMG from "../../components/images/Marko.png"

const Contact: React.FC = () => {
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ textShadow: '0 0 10px black' }}>
      <div className="w-full max-w-4xl p-8 bg-gray-700/60 border border-black rounded-lg shadow-md text-white">
        <h1 className="text-4xl mb-6 font-bold text-center">Contact</h1>
        <div className="mb-6">
          <div className="text-center">
            <img
              src="../../components/images/Marko.PNG"
              alt="Your Name"
