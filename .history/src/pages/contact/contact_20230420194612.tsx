  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ textShadow: '0 0 10px black' }}>
      <div className="w-full max-w-3xl p-8 mt-10 mb-10 mr-5 ml-5 bg-gray-700/60 border border-black rounded-lg shadow-md text-white">
        ...
        <h2 className="text-2xl mb-6 font-black text-center">( Junior Frontend Dev )</h2>
        <div className="mb-6">
        ...
        <div className="flex flex-col gap-5 text-large font-bold pl-6 mb-6 text-center mx-auto animate-pulse" style={{ maxWidth: '32rem' }}>
