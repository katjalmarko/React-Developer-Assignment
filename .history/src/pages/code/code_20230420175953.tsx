...
const code = () => {
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ textShadow: '0 0 10px black' }}>
      <div className="w-full max-w-2xl p-8 mt-10 mb-10 mr-5 ml-5 bg-gray-700/60 border border-black rounded-lg shadow-md text-white">
        <h1 className="text-4xl mb-6 font-black text-center">Code & Technologies</h1>
        ...
        <h3 className="text-2xl font-bold mt-10 mb-10 text-center">
        ...
        <p className="text-2xl font-bold mt-5 mb-5 text-center">
