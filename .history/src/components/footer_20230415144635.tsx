  ...
  return (
    <div>
      ...
      {filteredToDoList.map((todo) => (
        ...
        < key={todo.id} className={`border h-96 w-80 rotate-3 transform space-y-6 rounded-2xl bg-gray-100 p-6 duration-300 hover:rotate-0 ${todo.completion ? 'bg-green-400/50' : ''}`}>
          <div className="flex justify-end">
            <div className="h-4 w-4 rounded-full bg-gray-900"></div>
          </div>
