  ...
  return (
    <div className="flex flex-col sm:flex-row w-full h-auto items-center bg-gray-700/20 pb-4 sm:pb-0 lg:h-20 lg:justify-center">
      ...
      >
        <Link
          to="/"
          className="flex items-center justify-center lg:gap-2 sm:justify-start text-white bg-gradient-to-r rounded-2xl from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium text-sm px-5 py-2 text-center mt-2 mr-2 mb-2 sm:mt-0 sm:mb-0"
        >
