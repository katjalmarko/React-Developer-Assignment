  ...
  <h1 className='font-bold text-3xl sm:text-5xl tracking-widest animate-pulse text-white my-4 sm:my-0'>
   ...
   <div className='flex items-center gap-6 sm:gap-12 mr-6 sm:mr-14'>
     {user && (
       ...
       <button 
         onClick={logoutOfApp}
         className='text-white bg-gradient-to-r rounded-2xl from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium text-sm px-5 py-2.5 text-center mt- 2mr-2 mb-2'
         > 
