...
const footer = () => {
  return (
    ...
    <div key={todo.id} className={`bg-gray-200/20 border h-96 w-80 rotate-3 transform space-y-6 rounded-2xl bg-gray-100 p-6 duration-300 hover:rotate-0 ${todo.completion ? 'bg-green-400/50' : ''}`}>
