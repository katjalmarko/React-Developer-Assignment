  ...
  return (
    <div className="flex flex-col justify-center sm:flex-row w-full h-20 items-center bg-gray-700/20 pb-4 sm:pb-0">
      ...
      <div
        ...
        } flex-col sm:flex-row sm:items-center sm:ml-10 sm:gap-5 text-white`}
      >
        {/* The rest of your Links and Button code */}
        ...
        {user && (
          <div className="flex flex-col items-center text-white sm:flex-row sm:items-center">
            <img
              ...
              src={user?.photoURL || ""}
            />
            <p className="text-xs mt-1 sm:mt-0 sm:mr-2">{user?.displayName}</p>
            <button
              onClick={logoutOfApp}
