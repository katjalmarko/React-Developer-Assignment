...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row w-full h-20 items-center justify-between bg-gray-700/20 pb-4 sm:pb-0">
      ...
      >
        ...
        {user && (
          <>
            ...
            <button
              onClick={logoutOfApp}
              className="text-white bg-gradient-to-r rounded-2xl from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ringfocus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium text-sm px-5 py-2.5 text-center mt-2 mr-2 mb-2 sm:mt-0 sm:mb-0"
              >
