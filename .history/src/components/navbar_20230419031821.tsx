  ...
  return (
    ...
    <div className="flex justify-center w-full">
      <button
        ...
        className="z-10 text-white focus:outline-none sm:hidden mr-5"
      >
        <svg
      ...
      <div
        className={`fixed top-20 z-0 w-full bg-gray-700/20 ${
          menuOpen ? "flex" : "hidden"
        } flex-row justify-center gap-2 sm:static sm:flex sm:items-center sm:ml-10 sm:gap-5 text-white`}
      >
